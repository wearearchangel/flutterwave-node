...
const subaccount_collection = require('./lib/rave.subaccount_collection');
const subaccount_payout = require('./lib/rave.subaccount_payout');
...
const Rave = function (public_key, public_secret, base_url_or_production_flag) {
  ...
  this.CollectionSubaccount = new subaccount_collection(ravebase);
  this.PayoutSubaccount = new subaccount_payout(ravebase);
